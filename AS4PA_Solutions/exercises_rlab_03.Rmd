...
```
The resulting plot of my simulation can be found here: [6 boxes toy model](https://github.com/NicolaZomer/R_AdvStatistics_and_ComplexSystems/tree/main/AS4PA_Solutions/results/6_boxes_toy_model.html).
