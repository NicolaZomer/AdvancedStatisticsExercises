...
ggplot(new) +
  ...
  labs(title=paste("Number of vaccinations per European country per hundred on", last_date),
      x='Country',
...
Now, I want to do again the same thing in a fancier way, using the library `highcharter`. 
